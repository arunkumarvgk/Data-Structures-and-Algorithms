...
public class SqrtDecomposition {
	...
	public long query(final int left, final int right) {
		...
		System.out.println(startBlockIndex+" "+endIBlockIndex);
		long sum = 0;
	...
	public static void main(String[] args) {
		...
		System.out.println(sqrtDecomposition.query(7, 7));
		System.out.println(sqrtDecomposition.query(0, 1));
		System.out.println(sqrtDecomposition.query(3, 5));
